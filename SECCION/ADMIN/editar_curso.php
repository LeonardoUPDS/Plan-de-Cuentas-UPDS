...
<div class="container my-4">
  <div class="card">
    <div class="card-header d-flex justify-content-between align-items-center">
      <div><span>Editar Curso</span></div>
      <div>
    ...
    <div class="card-body">
      ...
      <form method="POST">
        <div class="mb-3">
          ...
          <input class="form-control" name="Nombre" value="<?= htmlspecialchars($curso['Nombre']) ?>" required>
        </div>
        <div class="mb-3">
          <label class="form-label">Descripción</label>
          <textarea class="form-control" name="Descripcion"><?= htmlspecialchars($curso['Descripcion']) ?></textarea>
        </div>
        <div class="form-check mb-3">
          <input class="form-check-input" type="checkbox" name="Estado" id="estado" <?= $curso['Estado'] ? 'checked' : '' ?>>
